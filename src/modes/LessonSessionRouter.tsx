...
export function LessonSessionRouter({ day, notes, splitNote, audio, bpm, onBpmChange, onGuideChange, onComplete, onSessionStart, metronomeVolume, onMetronomeVolumeChange }: Props) {
  ...
  if (definition.lessonType === 'mixedTest') return <MixedTestMode definition={definition} notes={notes} splitNote={splitNote} onGuideChange={onGuideChange} onComplete={onComplete} />;
