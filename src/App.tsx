    ...
    <div className={`app-shell ${focus ? 'focus-mode' : ''}`}>
      ...
      <main>
        ...
        <div className="content-area">
          ...
          {mode === 'songPractice' && <SongPracticeMode notes={noteArray} splitNote={splitNote} onGuideChange={setKeyboardGuide} onAllNotesOff={allSoundOff} midiConnected={Boolean(selectedMidi)} midiDeviceName={devices.find((device) => device.id === selectedMidi)?.name ?? ''} />}
